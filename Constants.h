...
/*
enum Z80HeaderResult {
    Z80_VERSION_1 = 1,
    Z80_VERSION_2 = 2,
    Z80_VERSION_3 = 3,
    Z80_ERROR_READ_V1_HEADER = -1,
    Z80_ERROR_READ_V2_HEADER_LENGTH = -2,
    Z80_ERROR_HEADER_TOO_LARGE = -3, // Not strictly used now, but kept for consistency
    Z80_ERROR_READ_V2_HEADER_DATA = -4,
    Z80_ERROR_UNKNOWN_HEADER_LENGTH = -5
};
*/
...
enum BlockReadResult {
    ...
    BLOCK_ERROR_READ_LENGTH = -1,
    BLOCK_ERROR_READ_PAGE = -2,
    BLOCK_ERROR_READ_DATA = -3,
    BLOCK_ERROR_VERSION = -4,
    BLOCK_ERROR_NO_V1_MARKER = -5
};

/*
enum ConversionResult {
    CONVERSION_SUCCESS = 0,
    CONVERSION_ERROR_OPEN_INPUT = -1,
    CONVERSION_ERROR_OPEN_OUTPUT = -2,
    CONVERSION_ERROR_READ_HEADER = -3,
    CONVERSION_ERROR_MACHINE_TYPE = -4,
    CONVERSION_ERROR_WRITE_SNA = -5,
    CONVERSION_ERROR_READ_BLOCK = -6,
    CONVERSION_ERROR_MEMORY_ALLOC = -7,
    CONVERSION_ERROR_RLE_DECODE = -8,
    CONVERSION_ERROR_INVALID_Z80_FORMAT = -9, // Added for pre-check failures
    CONVERSION_WARN_RLE_DECODE_MARKER = -10
};
*/
