...
// #if 0
//       {
//         // looks like this is quicker then the RLE option!
//         TransferPacket pkt(addr, input_len);
//         Z80Bus::sendBytes((uint8_t*)&pkt, sizeof(TransferPacket) );
...
//   constexpr uint8_t MIN_RUN_LENGTH = 4; // about where RLE pays off over raw
